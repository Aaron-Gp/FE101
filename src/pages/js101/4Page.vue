...
// output.innerHTML+="company"+company+"<br>";
// output.innerHTML+="dep"+dep+"<br>";
output.innerHTML+="myname"+myname+"<br>";
// showInfo();
// show();
...
var myname = "zhangqi";
function showInfo() {
    output.innerHTML+=""+company+dep+myname+"<br>";
    output.innerHTML+=""+myname+"<br>";
}
var show = function () {
    output.innerHTML+=""+myname+"<br>";
}
